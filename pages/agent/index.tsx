...
import { CREATE_CONTACTUS_AGENT_MUTATION } from '~/utils/graphql';
import { Form, Input, Button, Select, Alert } from 'antd';
import { useTranslation } from 'next-export-i18n';
import { defaultCities, defaultCountry } from '~/utils/constants';
...
const JoinAsAgent = () => {
  ...
  const [createContactUs] = useMutation(CREATE_CONTACTUS_AGENT_MUTATION, {
  ...
  return (
    <Container className="mainContainer propertyContainer bg-listBackground">
      <NextSeo title="Join to RECOM as Agent" description="Join to RECOM as agent." />
        ...
        <div className="flex justify-center lg:w-1/2 px-4 mt-4 lg:mt-0 items-center">
          <div className="w-full lg:w-sellProperty">
            <div className="mt-8 flex justify-between">
              <h1 className="text-40 text-item font-bold">{t('agent.JOIN_AS_AGENT')}</h1>
            </div>
            <div className="mt-4">
              <Form
                name="properties"
